...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Пополнение баланса пользователя</h1>
    </div>
    <div class="card mb-5">
        ...
        <div class="card-body">
            <form action="{{ route('admin.balance.add.update', ['id' => $customer->id]) }}" method="post">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="balance_rur" class="form-label">Баланс RUB - <b>{{ $customer->balance->balance_rur }}</b></label>
